...
class Score4:
    ...
    def __init__(self, _model_name, _test_dataset_filename):
        ...
        Score4.y_test = dataset['me_power'].values.reshape(-1, 1)
        ...
        self.test_X, self.test_y = to_sequences(self.X_test_scaled, Score4.y_test[:, :], sequence_size)
